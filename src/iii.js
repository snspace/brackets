...
(function() {
    ...
    var projectRoot = "/3/projects/iii";
    ...
    function load(Bramble) {
        ...
        Bramble.on("readyStateChange", function(previous, current) {
            console.log("III readyStateChange", previous, current);
        });

        Bramble.on("offlineReady", function() {
            console.log("III available for offline use.");
        });

        Bramble.on("updatesAvailable", function() {
            console.log("III offline content updated, please refresh to use.");
        });
    ...
    if(isSrc) {
        console.log("III src/ build");
        brambleModule = "../dist/bramble";
    } else {
        console.log("III dist/ build");
